...
exports.EconomicAnalyzer = void 0;
/**
...
class EconomicAnalyzer {
    ...
    analyzeTokenomics(tokenomics) {
        ...
        if (tokenomics.vestingSchedule && tokenomics.vestingSchedule.length > 0) {
            ...
            const upcomingUnlocks = tokenomics.vestingSchedule.filter(v => v.timestamp > now && v.timestamp < now + 30 * 24 * 3600);
    ...
    analyzeIncentiveAlignment(protocol) {
        const findings = [];
        let score = 0;
...
exports.EconomicAnalyzer = EconomicAnalyzer;
