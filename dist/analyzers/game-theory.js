...
exports.GameTheoryAnalyzer = void 0;
/**
...
class GameTheoryAnalyzer {
     ...
     */
    analyzeNashEquilibria(protocol) {
        const findings = [];
     ...
     */
    analyzeDominantStrategies(protocol) {
        const findings = [];
        ...
        if (protocol.pools) {
            const vulnerablePools = protocol.pools.filter(p => p.volume24h / p.liquidity > 0.3 && p.liquidity < 500000);
     ...
     */
    analyzeCoordinationGames(protocol) {
        const findings = [];
     ...
     * - Budget Balance
     */
    analyzeMechanismDesign(protocol) {
        const findings = [];
     ...
     */
    analyzeMultiAgentDynamics(protocol) {
        const findings = [];
...
exports.GameTheoryAnalyzer = GameTheoryAnalyzer;
